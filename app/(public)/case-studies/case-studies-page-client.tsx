...
import { CASE_STUDY_PROJECTS } from '@/lib/marketing/case-studies-projects'

/**
 * The public selected-work page. Projects and applications — not outcome case
 ...
 * publication.
 *
 * This page is self-contained: it renders inside the approved public layout and
 * imports nothing from the homepage or any other production page, and no other
 * page imports anything from here. Every class is `.cs-`-namespaced.
 */
