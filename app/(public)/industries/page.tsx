...
function IndustryCard({ industry, onPick }: { industry: typeof industries[number]; onPick: (name: string) => void }) {
...
export default function IndustriesPage() {
  ...
  const pickIndustry = (name: string) => { setSelectedIndustry(name); document.getElementById('industries-inquiry')?.scrollIntoView({ behavior: 'smooth', block: 'center' }) }
  ...
  return <div className="industries-page">
    ...
    <section className="ind-grid-section" id="industry-grid" ref={gridRef}>
      <div className="ind-section-inner">
        ...
        <div className="ind-grid">{industries.map(industry => <IndustryCard key={industry.name} industry={industry} onPick={pickIndustry} />)}</div>
      </div>
    </section>
