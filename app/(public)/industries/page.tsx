...
function IndustryCard({ industry }: { industry: typeof industries[number] }) {
  ...
  const style = { '--sx': '50%', '--sy': '50%', '--icon-bg': `linear-gradient(160deg,${industry.bg[0]},${industry.bg[1]})` } as CSSProperties
  return <article className="ind-card" data-reveal style={style} onPointerMove={spotlight}>
