...
describe("permissions and the live providers (tests 97-108)", () => {
  // 97
  it("resolves both search's and saved views' live mode to a live plane, each with no third branch", () => {
